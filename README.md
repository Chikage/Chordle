...
- `Free`：自由选择 1–72 EDO 音高，或以根音和纯 EDO 分数比例建立多组和弦；支持顺序/随机试听、组内排序与跨组交换。
- `Overtones`：随机基音上的整数泛音倍数听辨。
- 绿色、黄色、灰色以及 Extra 模式蓝/粉反馈。
- 行排序、单格和整行回放、上一行正确/错位格拖入下一行。
- 可缩放钢琴键盘和 EDO 标尺、泛音数字键盘。
- 音域、音数、EDO、泛音范围、128 个 MIDI Program 和按键预听设置。
- 完全离线，无账号、网络、广告或分析服务。
