...
Java_icu_ringona_chordle_audio_NativeAudioEngine_setupNative(JNIEnv *, jclass) {
    return engine.setup();
}

JNIEXPORT jboolean JNICALL
Java_icu_ringona_chordle_audio_NativeAudioEngine_startNative(JNIEnv *, jclass) {
    return engine.start();
}

JNIEXPORT void JNICALL
Java_icu_ringona_chordle_audio_NativeAudioEngine_teardownNative(JNIEnv *, jclass) {
    engine.teardown();
}

JNIEXPORT jboolean JNICALL
Java_icu_ringona_chordle_audio_NativeAudioEngine_restartNative(JNIEnv *, jclass) {
    return engine.restart();
}

JNIEXPORT jboolean JNICALL
Java_icu_ringona_chordle_audio_NativeAudioEngine_isStartedNative(JNIEnv *, jclass) {
    return engine.isStarted();
}

JNIEXPORT jboolean JNICALL
Java_icu_ringona_chordle_audio_NativeAudioEngine_loadSf2Native(
        JNIEnv *env,
        jclass,
        jstring filePath) {
...
Java_icu_ringona_chordle_audio_NativeAudioEngine_soundFontKeyNative(JNIEnv *env, jclass) {
...
JNIEXPORT void JNICALL
Java_icu_ringona_chordle_audio_NativeAudioEngine_unloadSf2Native(JNIEnv *, jclass) {
    engine.unloadSf2();
}

JNIEXPORT jboolean JNICALL
Java_icu_ringona_chordle_audio_NativeAudioEngine_hasSoundFontNative(JNIEnv *, jclass) {
    return engine.hasSoundFont();
}

JNIEXPORT jint JNICALL
Java_icu_ringona_chordle_audio_NativeAudioEngine_noteOnNative(
        JNIEnv *,
        jclass,
        jint key,
        jint velocity,
...
JNIEXPORT void JNICALL
Java_icu_ringona_chordle_audio_NativeAudioEngine_noteOffNative(JNIEnv *, jclass, jint noteId) {
    engine.noteOff(noteId);
}

JNIEXPORT void JNICALL
Java_icu_ringona_chordle_audio_NativeAudioEngine_allSoundOffNative(JNIEnv *, jclass) {
    engine.allSoundOff();
}

JNIEXPORT void JNICALL
Java_icu_ringona_chordle_audio_NativeAudioEngine_setGainNative(JNIEnv *, jclass, jfloat gain) {
    engine.setGain(gain);
}

JNIEXPORT void JNICALL
Java_icu_ringona_chordle_audio_NativeAudioEngine_setReverbNative(JNIEnv *, jclass, jint value) {
    engine.setReverb(value);
}

JNIEXPORT void JNICALL
Java_icu_ringona_chordle_audio_NativeAudioEngine_setPitchCalibrationNative(
        JNIEnv *env,
        jclass,
